(function($) {
    ...
    // detecting browser prefix and capabilities
    ...
    var api = {
        ...
        toggle: function() {
            ...
            $this = $( this );
            $this.Menu2su( $this.hasClass( 'open' ) ? 'close' : 'open' );
        },
    ...
    $.fn.Menu2su = function( options ) {
        ...
        var opts = $.extend( {}, $.fn.Menu2su.defaults, options );
    ...
    $.fn.Menu2su.enabled = canRun;

})( jQuery );


if ( $.fn.Menu2su.enabled ) {
